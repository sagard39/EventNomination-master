 ...
 */			
	...
	<div class="row ">
	<div class="col-sm-3 col-md-3 col-lg-3" id="big_logo" style="z-index:99; padding-left: 0px; ">
          <%if(get_color==null || get_color.equals("null")){%>
	...
	<div class="row ">
	 <div class="col-sm-12 col-md-12 col-lg-12 style-app-name">
         ...
         <h3 class="style-right style-text-white">Event Nomination &nbsp;&nbsp;&nbsp;&nbsp;</h3>
	   ...
	   <ul class="navbar-nav ml-md-auto">
			...
			<li class="nav-item dropdown" id="claimId2">
				...
				<%if("31926330".equals(login1) || "35322030".equals(login1)){%>
				<div class="dropdown-divider"></div>
