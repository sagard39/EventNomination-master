...
<%
	...
	String eventName = "", cutOffDate = "", totalTickets = "", ticketPrize = "", maxTicketsEmp = "",
			...
			lblName = "", lblType = "", defValues = "", isMandate = "",levelType="",empAgeCriteria="",participentCriteria="";
		...
		if ("Add Event".equals(nullVal(request.getParameter("submit1")))
			...
			if ("Y".equals(addFields)) {
				psEvtId = con.prepareStatement(
						"insert into nomination_addition(evt_id,lbl_name,lbl_type,def_value,ISMANDATE,LEVEL_TYPE) values(?,?,?,?,?,?)");
			...
			if (newLocnArrTemp.length != 0) {
				for (int i = 0; i < newLocnArrTemp.length; i++) {
					psAddFields = con.prepareStatement(
							"insert into nomination_addition (evt_id,lbl_name,lbl_type,def_value,ismandate) values (?,?,?,?,?)");
	...
	<div class="container">
		<div class="card mb12 box-shadow border-primary">
			...
			<div class="card-body">
				<div class="row altRow1">
					...
					<div class="col-md-6">
						...
						<div <%=isBU ? "" : "style='display:none'"%> id="divBu">
							<select multiple="multiple" class="form-control  selectNew"
				...
				<div class="row  altRow2">
					<div class="col-md-3">
						<label for="eventDateFrom">Event Start Date</label> <input
							type="text" name="evt_date" class="form-control datepicker"
							id="evt_date" readonly value="<%=eventFromDate%>">
					</div>
					<div class="col-md-3">
						<label for="eventDateFrom">Event End Date</label> <input
							type="text" name="evt_date_to" class="form-control datepicker"
					...
					<div class="col-md-3">
						...
						<input type="text" name="cutofdte" value="<%=cutOffDate%>"
							class="form-control datepicker" id="cutofdte" readonly>
					</div>
					<div class="col-md-3">
						<label for="">Total Tickets for Event</label> <input type="number"
							class="form-control" name="nooftickts" id="nooftickts"
				...
				<div class="row  altRow1">
					<div class="col-md-3">
						<label for="">Price per Ticket</label> <input type="text"
							class="form-control" name="priceevt" id="priceevt" maxlength="5"
					...
					<div class="col-md-3">
						<label for="">Max Tickets per Employee</label> <input
							type="number" class="form-control" name="maxtickemp"
							id="maxtickemp" maxlength="20"
							onkeypress="return isNumeric(event)" value="<%=maxTicketsEmp%>"
							onkeydown="return isNumeric(event)">
					</div>
					<div class="col-md-3">
						<label for="">Minimum Age</label> <select class="form-control"
					...
					<div class="col-md-3">
						<label for="">Maximum Age</label> <select class="form-control"
				...
				<div class="row  altRow2">
					...
					<div class="col-md-3">
						<label for="">Event Category(Gender)</label><br> <input
							type="radio" name="evt_gen" value="M"
							<%=eventGender.equals("M") ? "checked" : ""%> id="male"
							class="evt_gen">&nbsp; Male&nbsp; <input type="radio"
							name="evt_gen" value="F"
							<%=eventGender.equals("F") ? "checked" : ""%> id="female"
							class="evt_gen">&nbsp; Female&nbsp; <input type="radio"
							id="both" name="evt_gen"
							<%=eventGender.equals("B") ? "checked" : ""%> value="B"
							class="evt_gen">&nbsp; Both&nbsp;
					</div>
					<div class="col-md-3">
						<label for="">Participant Gender</label><br>
						<input type="radio" name="participateGender" id="participateGender1" value="M"/>&nbsp Male &nbsp;
						<input type="radio" name="participateGender" id="participateGender2" value="F"/>&nbsp; Female&nbsp;
						<input type="radio" name="participateGender" id="participateGender3" value="B"/>&nbsp Both &nbsp;
					</div>
					<br>
				</div>
				<div class="row  altRow1">
					<div class="col-md-3">
						<label for="">Choose First Admin for Event</label> <input
							type="text" name="adminEmp" id="adminEmp" class="form-control"
							value="<%=admin1%>" />
					</div>
					<div class="col-md-3">
						<label for="">Choose Second Admin for Event</label> <input
							type="text" name="adminEmp1" id="adminEmp1" class="form-control"
							value="<%=admin2%>" />
					</div>
					<div class="col-md-3">
						<label for="">Customization for Email</label><br> <input
							type="radio" name="customMail" id="customMail_Y"
							data-toggle="modal" data-html="true" data-target="#Modal2"
							class="inline-check" value="Y"> Yes&nbsp; <input
							type="radio" name="customMail" id="customMail_N"
				...
				<div class="row altRow2">
					<div class="col-md-3">
						...
						<select name="empAgeMin" id="empAgeMin" class="form-control">
							<option value="-1">Select</option>
							<%for(int i=18;i<=62;i++){%>
					...
					<div class="col-md-3">
						...
						<select name="empAgeMax" id="empAgeMax" class="form-control">
							<option value="-1">Select</option>
							<%for(int i=18;i<=62;i++){%>
				...
				<div class="newDivMail col-md-12">
					<span name="newSpanMail" id="newSpanMail"></span> <input
						type="hidden" name="hidMailBody" id="hidMailBody" />
				</div>
				<div <%=!isAddFields ? "style='display:none'" : ""%> class="chkValDiv">
					...
					<a title="Add" href="javascript:;" onclick="addEntry()"><img
						...
						style="margin-right: 100px">Add </span>&nbsp;<span><input type="radio" name="radLvlCol" value="E" class="radColLvl" id="radLvlCol1" />&nbsp;Event Level&nbsp;
						<input type="radio" name="radLvlCol" value="A" id="radColLvl2" class="radColLvl" />&nbsp;Applicant Level
						</span>
					<div class="datagrid">
					...
					<div class="modal-dialog modal-lg modal-dialog-centered"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<textarea class="form-control" name="pickPnts" id="pickPnts"
				...
				<div class="modal model-lg fade" id="Modal2" tabindex="-1"
					...
					<div class="modal-dialog modal-lg modal-dialog-centered"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<textarea class="form-control" name="emailContent"
									id="emailContent" cols="99%" rows="5"></textarea>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-primary btn-md"
									data-dismiss="modal" aria-label="Close"
			...
			<div class="card-footer">
				<center>
					<%
						if ("".equals(editPara)) {
					%>
					<button class="btn btn-primary" type="submit" name="submit1"
