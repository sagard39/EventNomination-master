...
PreparedStatement ps=con2.prepareStatement("select trim(budesc) emp_name, trim(bu) emp_no from workflow.empmaster where emp_no like ? or lower(emp_name) like ?");
ps.setString(1, "%"+q+"%");
ps.setString(2, "%"+q+"%");
